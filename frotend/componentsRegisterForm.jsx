...
export default function RegisterForm() {
  ...
  async function register(e) {
    ...
    const res = await fetch("/api/user/register", {
      ...
      body: JSON.stringify({ username, displayName, password: pw }),
    });
  ...
  return (
    <form onSubmit={register}>
      <input type="text" value={username} required placeholder="ユーザー名（後から変更不可）" onChange={e => setUsername(e.target.value)} />
